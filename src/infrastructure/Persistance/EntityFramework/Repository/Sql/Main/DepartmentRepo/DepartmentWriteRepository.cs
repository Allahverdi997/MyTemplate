...
{
    public class DepartmentWriteRepository : SqlGenericWriteRepository<Department>, IDepartmentWriteRepository
    {
        public DepartmentWriteRepository(ISqlDbContext appDbContext) : base(appDbContext)
        {
